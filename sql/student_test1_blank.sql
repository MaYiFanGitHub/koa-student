...
CREATE TABLE `t_role` (
  ...
  `is_delete` tinyint(1) DEFAULT '0' COMMENT '�Ƿ�ɾ��',
  PRIMARY KEY (`role_id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='��ɫ��';

-- ----------------------------
-- Records of t_role
-- ----------------------------
INSERT INTO `t_role` VALUES ('0', '管理员', '[\"/welcome\",\"/role\",\"/user\",\"/user/userAdd\",\"/user/userList\",\"/college\",\"/college/add\",\"/college/list\"]', '0');
INSERT INTO `t_role` VALUES ('1', '院长', '[\"/welcome\",\"/user\",\"/user/userAdd\",\"/user/userList\",\"/college/list\",\"/major/list\",\"/class/list\",\"/course/list\",\"/score/list\",\"/person\",\"/person/add\",\"/person/password\",\"/honor/list\",\"/job/list\"]', '0');
INSERT INTO `t_role` VALUES ('2', '教师', '[\"/welcome\",\"/college/list\",\"/major/list\",\"/class/list\",\"/course/list\",\"/score/add\",\"/score/list\",\"/score/examine\",\"/person\",\"/person/add\",\"/person/password\",\"/honor/list\",\"/job/list\",\"/studentInfo/list\"]', '0');
INSERT INTO `t_role` VALUES ('3', '学生', '[\"/welcome\",\"/college/list\",\"/major/list\",\"/class/list\",\"/course/list\",\"/score/studentList\",\"/person\",\"/person/add\",\"/person/password\",\"/roll/add\",\"/roll/person\",\"/honor/query\",\"/job/list\"]', '0');
INSERT INTO `t_role` VALUES ('4', '教秘', '[\"/welcome\",\"/user\",\"/user/userAdd\",\"/user/userList\",\"/college/list\",\"/major\",\"/major/add\",\"/major/list\",\"/class\",\"/class/add\",\"/class/list\",\"/course\",\"/course/add\",\"/course/list\",\"/score/list\",\"/score/examine\",\"/person\",\"/person/add\",\"/person/password\",\"/roll/list\",\"/honor/add\",\"/honor/list\",\"/job\",\"/job/add\",\"/job/list\",\"/studentInfo/list\"]', '0');
